...
function! folddigest#AutoRefresh()
...
function! folddigest#FoldDigestIsOpen() abort
...
function! folddigest#FoldDigestClose() abort
  if ! exists('g:folddigest_buf')
    return
  endif
...
function! folddigest#FoldDigestToggle() abort
  if folddigest#FoldDigestIsOpen()
    call folddigest#FoldDigestClose()
  else
    call folddigest#FoldDigest()
  endif
endfunction
